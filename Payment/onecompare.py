...
def onecompare(searchedid):
    ...
    query = 'SELECT mn, Division, Elemtype, CASE WHEN Elemtype = "addition components" THEN 1 WHEN Elemtype = "benefit charge components" THEN 2 WHEN Elemtype = "compulsory deductions" THEN 3 WHEN Elemtype = "voluntary deductions" THEN 4' \
    ...
    return resdf[["Division","mn","Elemtype_heb","Elem_heb","Period","CurAmount","PrevAmount","Diff"]].to_dict('index')
#